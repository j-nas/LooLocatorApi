...
namespace LooLocatorApi.Migrations
{
    ...
    [Migration("20231122041258_moved_relations_to_json_columns")]
    partial class moved_relations_to_json_columns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LooLocatorApi.Models.Bathroom", b =>
                {
                    b.OwnsOne("LooLocatorApi.Models.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("BathroomId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.HasKey("BathroomId");

                            b1.ToTable("bathrooms");

                            b1.ToJson("Address");

                            b1.WithOwner()
                                .HasForeignKey("BathroomId")
                                .HasConstraintName("fk_bathrooms_bathrooms_id");
                        });
